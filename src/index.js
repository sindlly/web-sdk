...
if (localStorage.getItem("liveUrl")) {
    document.getElementById("liveInput").value = localStorage.getItem("liveUrl")
    flvUrl  = localStorage.getItem("liveUrl")
}
if (localStorage.getItem("audioUrl")) {
    document.getElementById("audioInput").value = localStorage.getItem("audioUrl")
}
document.getElementById("liveInput").addEventListener("change", (e) => {
    flvUrl = e.target.value
    localStorage.setItem("liveUrl", flvUrl)
})
...
document.getElementById("play").onclick = () => {
    ...
    document.getElementById("playHls-btn").onclick = () => {
        player.playAtTime(urlData[0].start_time, '', urlData)
    }
